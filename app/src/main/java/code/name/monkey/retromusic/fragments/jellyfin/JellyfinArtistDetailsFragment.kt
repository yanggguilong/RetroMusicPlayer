...
import code.name.monkey.retromusic.databinding.FragmentJellyfinArtistDetailsBinding
...
class JellyfinArtistDetailsFragment : AbsMainActivityFragment(R.layout.fragment_jellyfin_artist_details) {

    private var _binding: FragmentJellyfinArtistDetailsBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding = FragmentJellyfinArtistDetailsBinding.bind(view)
    ...
    private fun setupUI() {
        ...
        mainActivity.supportActionBar?.title = "艺术家详情"
    ...
    private fun loadArtistDetails() {
        val artistId = arguments?.getString("artist_id") ?: return
        ...
        viewModel.loadSongs() // 这里需要修改为加载艺术家的歌曲
    }
